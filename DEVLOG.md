...
| | |
|---|---|
| **Status** | Tai v1.1.3 live on Sui testnet (unaudited) · `tai-cli` / `tai-core` / `tai-mcp` 0.1.2 on crates.io · one site (marketing + dashboard + docs + gallery) live · Larry stays on legacy v1.0.1 |
| **Install** | `cargo install tai-cli` (also requires the `sui` CLI on PATH) |
| **On-chain — Tai protocol** | callable package v1.1.3 [`0xf6a5…573b`](https://suiscan.xyz/testnet/object/0xf6a55d1f6b4961de636028ee967adf1999063140d9331027abcf4b39c5dc573b) · LaunchpadConfig [`0x4a8b…3c50`](https://suiscan.xyz/testnet/object/0x4a8bdc697738df24f01f6161af29e70136b326db072e3d7e3630b3711f673c50) · types/events anchored to origin `0x7d86…efb3` |
